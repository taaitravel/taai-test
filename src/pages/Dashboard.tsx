    ...
    <div className="min-h-screen bg-[#171821]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 relative overflow-hidden">
          ...
          <h1 className="text-3xl font-bold text-white mb-2 relative">Welcome back, John! ✈️</h1>
          <p className="text-lg text-white/70 relative">Ready to plan your next adventure?</p>
        </div>
          ...
          <Card className="border-white/30 hover:shadow-2xl hover:shadow-white/20 transition-all duration-300 bg-[#171821]/80 backdrop-blur-md group">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-white/70">Total Trips</p>
