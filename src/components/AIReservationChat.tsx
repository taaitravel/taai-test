            ...
            <div className="flex flex-wrap gap-2">
              {travelServices.map((action, index) => (
                <Button
                  ...
                  className="bg-[#171821] text-white border border-white/20 hover:gold-gradient hover:text-white hover:border-0 shadow-lg transition-all duration-300"
                >
                  {action.label}
                </Button>
              ))}
              ...
              <Popover key={index}>
                <PopoverTrigger asChild>
                  <Button
                    variant="outline"
                    size="sm"
                    className="bg-[#171821] text-white border border-white/20 hover:gold-gradient hover:text-white hover:border-0"
                  >
