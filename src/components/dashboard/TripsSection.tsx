            ...
            <div className="relative h-[400px]">
              {activeItineraries
                ...
                .map((trip, index) => (
                  <Card 
                    key={trip.id}
                    className="absolute w-full aspect-[3/4] trip-card-upcoming cursor-pointer hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 group"
                    style={{
          ...
          <div className="relative h-[400px]">
            {activeItineraries
              ...
              .map((trip, index) => (
                <Card 
                  key={trip.id}
                  className="absolute w-full aspect-[3/4] trip-card-past cursor-pointer hover:shadow-lg hover:shadow-gray-500/10 transition-all duration-300 group"
                  style={{
                    transform: `translateY(${index * 12}px) translateX(${index * 6}px) rotateZ(${index * 3}deg)`,
                    zIndex: 10 - index
                  }}
