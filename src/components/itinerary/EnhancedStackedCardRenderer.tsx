...
export const EnhancedHotelCardRenderer = (hotel: any, index: number) => {
  const locationDisplay = typeof hotel.location === 'object' && hotel.location?.city 
    ? hotel.location.city 
...
export const EnhancedActivityCardRenderer = (activity: any, index: number) => {
  const locationDisplay = typeof activity.location === 'object' && activity.location?.city 
...
export const EnhancedReservationCardRenderer = (reservation: any, index: number) => {
  const locationDisplay = typeof reservation.location === 'object' && reservation.location?.city 
