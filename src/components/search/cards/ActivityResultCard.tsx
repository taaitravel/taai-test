...
export const ActivityResultCard = ({ activity, searchParams, planningAction }: ActivityResultCardProps) => {
  ...
  const handleModalConfirm = async (itineraryId: string | 'new', newItineraryName?: string, startDate?: string, endDate?: string) => {
    ...
    try {
      ...
      const activityLocation = {
        city: activity.location || activity.address || 'Unknown',
