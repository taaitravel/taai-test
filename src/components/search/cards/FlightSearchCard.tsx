...
export const FlightSearchCard = ({ flight, onExpand }: FlightSearchCardProps) => {
  ...
  const departureDate = new Date(flight.departure).toLocaleDateString();
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-white/60">{flight.flight_number}</p>
        </div>
      ...
      <div className="bg-white/5 p-6 rounded-lg border border-white/20">
        <div className="flex items-center justify-between mb-4">
          <div className="text-center flex-1">
            <p className="text-3xl font-bold text-white">{flight.from}</p>
          ...
          <div className="flex-1 flex flex-col items-center">
            ...
            <p className="text-white/60 text-sm mt-1">{flight.duration || '6h 30m'}</p>
          </div>
